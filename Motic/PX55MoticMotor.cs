...
namespace Motic
{
    public class PX55MoticMotor : IMotor
    {
        ...
        public bool XLimit => false;//原函数未提供

        public bool YLimit => false;

        public bool ZLimit => false;
        ...
        public async Task<bool> SetXOffsetAsync(double x)
            => await _pX55.RelativeMoveAsync(xAxis, x > 0, (int)(x / _pX55.UnitXY));
        ...
        public async Task<bool> SetYOffsetAsync(double y)
            => await _pX55.RelativeMoveAsync(yAxis, y > 0, (int)(y / _pX55.UnitXY));
        ...
        public async Task<bool> SetZOffsetAsync(double z)
            => await _pX55.RelativeMoveAsync(zAxis, z > 0, (int)(z / _pX55.UnitZ));
